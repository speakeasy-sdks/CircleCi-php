...
class GetPipelineByNumberPipelineVcs
{
     ...
     * 
     * @var ?\CircleCi\Models\Operations\GetPipelineByNumberPipelineVcsCommit $commit
     */
	#[\JMS\Serializer\Annotation\SerializedName('commit')]
    #[\JMS\Serializer\Annotation\Type('CircleCi\Models\Operations\GetPipelineByNumberPipelineVcsCommit')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetPipelineByNumberPipelineVcsCommit $commit = null;
