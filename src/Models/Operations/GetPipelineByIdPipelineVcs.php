...
class GetPipelineByIdPipelineVcs
{
     ...
     * 
     * @var ?\CircleCi\Models\Operations\GetPipelineByIdPipelineVcsCommit $commit
     */
	#[\JMS\Serializer\Annotation\SerializedName('commit')]
    #[\JMS\Serializer\Annotation\Type('CircleCi\Models\Operations\GetPipelineByIdPipelineVcsCommit')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetPipelineByIdPipelineVcsCommit $commit = null;
